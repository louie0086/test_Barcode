...
let barcodeDetector
export const setScanningFormats = (formats) => {
...
export const processFile = async (file, formats = ['qr_code']) => {
...
export const processUrl = async (url, formats = ['qr_code'])  => {
  const barcodeDetector = new BarcodeDetector({
    formats
  })
